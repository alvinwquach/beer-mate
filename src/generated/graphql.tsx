...
export type BeerFragmentFragment = { __typename?: 'Beer', id: number, name: string, tagline: string, first_brewed: string, description: string, image_url?: string | null, abv: number, ibu: number, target_fg: number, target_og: number, ebc?: number | null, srm?: number | null, ph: number, attenuation_level: number, food_pairing: Array<string>, brewers_tips: string, contributed_by: string, volume?: { __typename?: 'Volume', value: number, unit: string } | null, boil_volume?: { __typename?: 'BoilVolume', value: number, unit: string } | null, method?: { __typename?: 'Method', twist?: string | null, mash_temp: Array<{ __typename?: 'MashTemperature', temp?: { __typename?: 'Temperature', value?: number | null, unit: string } | null }>, fermentation?: { __typename?: 'Fermentation', temp?: { __typename?: 'Temperature', value?: number | null, unit: string } | null } | null } | null, ingredients?: { __typename?: 'Ingredients', yeast: string, malt: Array<{ __typename?: 'Malt', name: string, amount?: { __typename?: 'Amount', value: number, unit: string } | null }>, hops: Array<{ __typename?: 'Hops', name: string, add: string, attribute: string, amount?: { __typename?: 'Amount', value: number, unit: string } | null }> } | null };
